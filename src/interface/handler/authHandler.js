...
const DeleteAccountUseCase = require('../../application/use-cases/auth/DeleteAccountUseCase');
const GetProfileUseCase = require('../../application/use-cases/auth/GetProfileUseCase');
